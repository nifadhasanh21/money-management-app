  ...
  return (
    <div className="card">
      ...
      <div className="table-wrap">
        <table>
          <thead><tr><th>Date</th><th>Type</th><th>Category/Source</th><th>Amount</th><th>Description</th><th></th></tr></thead>
          <tbody>
            {filtered.length === 0 ? (
              ...
              filtered.map(tx => (
                <tr key={tx.id}>
                  ...
                  <td><button className="btn btn-danger" style={{ padding: '0.2rem 0.8rem', fontSize: '0.8rem' }} onClick={() => onDelete(tx.id)}>Delete</button></td>
                </tr>
              ))
            )}
          </tbody>
